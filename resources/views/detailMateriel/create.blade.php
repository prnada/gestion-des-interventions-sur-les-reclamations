<x-app-layout>
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <h3 class="border-bottom pb-2 mb-4">Ajout d'un nouvel matériel</h3>
        <div class="mt-4">
            ...
            <form style="width:60%" method="post" action="{{route('DetailMateriel.ajouter')}}">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Réference</label>
