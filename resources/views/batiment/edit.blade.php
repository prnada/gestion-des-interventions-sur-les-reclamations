<x-app-layout>
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <h3 class="border-bottom pb-2 mb-4">Edition d'un batiment</h3>
        <div class="mt-4">
            ...
            <form style="width:60%" method="post" action="{{route('Batiment.update', ['batiment'=>
                $batiment->id]) }}">
                @csrf
                <input type="hidden" name="_method" value="put">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Batiment</label>
                    <input type="text" class="form-control" name="Batiment" value="{{$batiment->Batiment}}">
                </div>
                <div class="mb-3">
